...
export const UI = {
  ...
  materialsLede: {
    en: 'PDFs and photographed pages, filed under the paper — and the topic — they belong to. Files you add stay on this device; nothing is uploaded. Every copy you save carries the CircularTriangle watermark.',
    ne: 'पीडीएफ र तस्बिर खिचिएका पृष्ठ, आफू पर्ने पत्र र विषयअन्तर्गत राखिएका। तपाईंले थप्नुभएका फाइल यही यन्त्रमै रहन्छन्; कतै अपलोड हुँदैन। सुरक्षित गर्ने हरेक प्रतिलिपिमा CircularTriangle वाटरमार्क रहन्छ।',
  },
  addMaterial: { en: 'Add a PDF or a photo', ne: 'पीडीएफ वा तस्बिर थप्नुहोस्' },
  chooseFile: { en: 'Choose a file', ne: 'फाइल छान्नुहोस्' },
  ...
  writtenLede: {
    en: 'Papers II onwards are answered in writing, not by choosing an option. Each question here carries the marks and the minutes the commission allows, and a model answer to check your own against.',
    ne: 'द्वितीय पत्रदेखि उत्तर लेखेर दिनुपर्छ, विकल्प छानेर होइन। यहाँका प्रत्येक प्रश्नमा आयोगले तोकेको अङ्क र समय तथा आफ्नो उत्तर जाँच्न नमुना उत्तर दिइएको छ।',
  },
  writtenQuestions: { en: 'questions', ne: 'प्रश्न' },
  practiceObjectiveOnly: {
    en: 'Multiple choice, for the first paper — the only paper set as objective questions.',
    ne: 'बहुवैकल्पिक, प्रथम पत्रका लागि — वस्तुगत प्रश्न सोधिने एक मात्र पत्र त्यही हो।',
  },
  practiceWrittenPointer: {
    en: 'Papers II onwards: long questions with model answers',
    ne: 'द्वितीय पत्रदेखि: नमुना उत्तरसहितका लामो प्रश्न',
  },
  writtenOfPaper: { en: 'of the paper', ne: 'पत्रको' },
  writtenNoneYet: { en: 'No questions written for this paper yet', ne: 'यस पत्रका प्रश्न अझै तयार भएका छैनन्' },
  writtenNoPaper: { en: 'This post has no such written paper', ne: 'यस पदमा त्यस्तो लिखित पत्र छैन' },
  writtenNoQuestion: { en: 'That question is no longer in the set', ne: 'त्यो प्रश्न अब यो सङ्ग्रहमा छैन' },
  writtenVsQuiz: {
    en: 'Multiple choice practice is under Practice, for the first paper — that is the only paper actually set as objective questions.',
    ne: 'बहुवैकल्पिक अभ्यास अभ्यास खण्डमा छ, प्रथम पत्रका लागि — वस्तुगत प्रश्न सोधिने एक मात्र पत्र त्यही हो।',
  },
  writtenYourAttempt: { en: 'Your attempt', ne: 'तपाईंको उत्तर' },
  writtenAttemptHint: {
    en: 'Write the answer here before looking at the model — an introduction, the points under headings, then a conclusion.',
    ne: 'नमुना उत्तर हेर्नुअघि यहाँ उत्तर लेख्नुहोस् — परिचय, शीर्षकअन्तर्गतका बुँदा, त्यसपछि निष्कर्ष।',
  },
  writtenDraftLocal: {
    en: 'Saved on this device only. Nothing is uploaded.',
    ne: 'यस यन्त्रमा मात्र सुरक्षित। कतै अपलोड हुँदैन।',
  },
  writtenKeyPoints: { en: 'Key points a marker looks for', ne: 'परीक्षकले खोज्ने मुख्य बुँदा' },
  writtenModelAnswer: { en: 'Model answer', ne: 'नमुना उत्तर' },
  writtenModelFuller: {
    en: 'This is fuller than anyone can write in the time allowed. The key points above are the exam-length skeleton; take from this to fill it out, and to see which Act or article to name.',
    ne: 'यो तोकिएको समयमा लेख्न सकिनेभन्दा विस्तृत छ। माथिका मुख्य बुँदा परीक्षामा लेख्ने ढाँचा हुन्; त्यसलाई भरिपूर्ण बनाउन र कुन ऐन वा धाराको नाम लिने हो थाहा पाउन यहाँबाट लिनुहोस्।',
  },
  writtenConclusion: { en: 'Conclusion', ne: 'निष्कर्ष' },
  writtenAuthorities: { en: 'Name these in your answer', ne: 'उत्तरमा यीनको नाम उल्लेख गर्नुहोस्' },
  words: { en: 'words', ne: 'शब्द' },
  show: { en: 'Show', ne: 'देखाउनुहोस्' },
  hide: { en: 'Hide', ne: 'लुकाउनुहोस्' },
  clear: { en: 'Clear', ne: 'मेट्नुहोस्' },
  ...
  pdfFailed: {
    en: 'This file could not be opened here. Try opening it in a new tab.',
    ne: 'यो फाइल यहाँ खोल्न सकिएन। नयाँ ट्याबमा खोलेर हेर्नुहोस्।',
  },
  ...
  materialNotSupported: {
    en: 'That file is neither a PDF nor a picture. Choose a PDF, PNG, JPG or WebP.',
    ne: 'त्यो फाइल न पिडिएफ हो न तस्बिर। पिडिएफ, पिएनजी, जेपिजी वा वेबपी छान्नुहोस्।',
  },
  materialStamping: { en: 'Stamping…', ne: 'छाप लगाउँदै…' },
  materialStamped: { en: 'Your copy was saved with the watermark.', ne: 'तपाईंको प्रतिलिपि वाटरमार्कसहित सुरक्षित भयो।' },
  materialStampFailed: { en: 'The copy could not be stamped. Try opening it in a new tab instead.', ne: 'प्रतिलिपिमा छाप लगाउन सकिएन। नयाँ ट्याबमा खोलेर हेर्नुहोस्।' },
  materialStampNote: {
    en: 'Every copy you save carries the CircularTriangle watermark on each page.',
    ne: 'तपाईंले सुरक्षित गर्ने हरेक प्रतिलिपिको प्रत्येक पृष्ठमा CircularTriangle वाटरमार्क रहन्छ।',
  },
  materialTopic: { en: 'Topic', ne: 'विषय' },
  // Publishing desk
  publishTitle: { en: 'Publish a material', ne: 'सामग्री प्रकाशन' },
  publishLede: {
    en: 'Put a PDF or a photo up so every customer sees it on their next visit. No new version of the app is needed.',
    ne: 'पिडिएफ वा तस्बिर राख्नुहोस्, हरेक ग्राहकले अर्कोपटक खोल्दा देख्नेछन्। एपको नयाँ संस्करण चाहिँदैन।',
  },
  publishPreviewWarning: {
    en: 'This build has no publishing service configured, so it is running a preview that stores files in this browser only — nothing you publish here reaches anyone else. Sign in with:',
    ne: 'यो बिल्डमा प्रकाशन सेवा जडान गरिएको छैन, त्यसैले यो पूर्वावलोकन यही ब्राउजरमा मात्र फाइल राख्छ — यहाँ प्रकाशित गरेको कुरा अरू कसैसम्म पुग्दैन। यसबाट साइन इन गर्नुहोस्:',
  },
  publishSignIn: { en: 'Sign in', ne: 'साइन इन' },
  publishSignOut: { en: 'Sign out', ne: 'साइन आउट' },
  publishSignedIn: { en: 'Signed in as the owner', ne: 'स्वामीको रूपमा साइन इन' },
  publishEmail: { en: 'Email', ne: 'इमेल' },
  publishPassword: { en: 'Password', ne: 'पासवर्ड' },
  publishWorking: { en: 'Working…', ne: 'काम हुँदैछ…' },
  publishNew: { en: 'New material', ne: 'नयाँ सामग्री' },
  publishChoosePaper: { en: 'Choose a paper', ne: 'पत्र छान्नुहोस्' },
  publishSection: { en: 'Section', ne: 'खण्ड' },
  publishNow: { en: 'Publish to everyone', ne: 'सबैका लागि प्रकाशन गर्नुहोस्' },
  publishDone: { en: 'Published. Every customer will see it on their next visit.', ne: 'प्रकाशित भयो। हरेक ग्राहकले अर्कोपटक खोल्दा देख्नेछन्।' },
  publishWithdraw: { en: 'Withdraw', ne: 'फिर्ता लिनुहोस्' },
  publishWithdrawn: { en: 'Withdrawn. It is no longer available to anyone.', ne: 'फिर्ता लिइयो। अब कसैलाई उपलब्ध छैन।' },
  publishLive: { en: 'Published to everyone', ne: 'सबैका लागि प्रकाशित' },
  publishNothingYet: { en: 'Nothing published yet', ne: 'अहिलेसम्म केही प्रकाशित छैन' },
  publishStampNote: {
    en: 'The file is watermarked with CircularTriangle in this browser before it is uploaded, so the copy stored online already carries the mark.',
    ne: 'अपलोड हुनुअघि यही ब्राउजरमा फाइलमा CircularTriangle वाटरमार्क लाग्छ, त्यसैले अनलाइन राखिने प्रतिलिपिमा पहिले नै छाप हुन्छ।',
  },
  materialWholeSection: { en: 'The whole section', ne: 'सिङ्गो खण्ड' },
  materialPhoto: { en: 'Photo', ne: 'तस्बिर' },
  materialPdf: { en: 'PDF', ne: 'पिडिएफ' },
  materialTooLarge: {
